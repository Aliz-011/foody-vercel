  ...
  return (
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden w-full h-full md:flex justify-between">
        <Link to={'/'} className="flex items-center gap-2">
          ...
          <p className="text-xl font-bold text-headingColor">
            dini<span className="text-green-500">store</span>
          </p>
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor duration-200 transition-all ease-in-out">
              Home
            </li>
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor duration-200 transition-all ease-in-out">
              Menu
          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className="w-40 flex flex-col bg-gray-50 shadow-xl rounded-lg absolute px-4 py-2 top-12 right-0"
              >
      ...
      <div className="flex w-full h-full items-center justify-between md:hidden">
        ...
        <Link to={'/'} className="flex items-center gap-2">
          <img src={Logo} alt="logo" className="object-cover w-8" />
          <p className="text-xl font-bold text-headingColor">dinistore</p>
        </Link>
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="flex py-2 rounded-md bg-gray-300 items-center gap-3 justify-center cursor-pointer transition-all duration-200 ease-in-out text-textColor text-base"
                onClick={logout}
              >
                Logout <MdLogout />
              </p>
